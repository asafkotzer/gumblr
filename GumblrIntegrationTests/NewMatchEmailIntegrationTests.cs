...
namespace GumblrIntegrationTests
{
    ...
    {
        [TestMethod]
        public void NewMatchesEmailGenerator_SingleMatch_Send()
        {
        ...
        [TestMethod]
        public void NewMatchesEmailGenerator_TwoMatches_Send()
        {
            AsyncContext.Run(async () =>
            {
                var fakeConfigurationRetriever = new FakeConfigurationRetriever()
                {
                ...
                var model = new NewMatchesModel()
                {
                    ...
                    { 
                        new Match { Host = "Brazil", Visitor = "Croatia", StartTime = new DateTime(2014, 06, 12, 17, 0, 0), Stage = MatchStage.Group }, 
                        new Match { Host = "Mexico", Visitor = "Cameroon", StartTime = new DateTime(2014, 06, 13, 13, 0, 0), Stage = MatchStage.Group }, 
                    },
                };
